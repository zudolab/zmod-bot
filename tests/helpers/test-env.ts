...
import migration0009 from "../../migrations/0009_policy_rollback_attempts.sql?raw";
 ...
 * 0003 through 0009 only ALTER/CREATE against tables 0001 creates or
 * independent storage, so applying them before an opt-in 0002 is
